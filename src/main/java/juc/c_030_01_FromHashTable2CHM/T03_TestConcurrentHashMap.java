...
public class T03_TestConcurrentHashMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SynchronizedHashMap 存放元素：" + (end - start));

        //因为SynchronizedHashMap内部方法都加上了synchronized，所以在多线程添加元素时不会有问题
        ...
        //巨慢，和HashTable差不多
        System.out.println("SynchronizedHashMap获取元素时间：" + (end - start));
    }
}
